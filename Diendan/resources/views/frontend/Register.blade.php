          ...
          <div class="card">
            <div class="card-body">
              ...
              @if(Request::get("notify") == "username-exists")
					...
					@endif
                    @if(Request::get("notify") == "confirm-exists")
					<div class="alert alert-danger" role="alert">vui lòng đồng ý điều khoản!</div>
					@endif
                    @if(Request::get("notify") == "password-exists")
					<div class="alert alert-danger" role="alert">xác nhận mật khẩu sai!</div>
					@endif
              ...
              <form id="formregistication" class="mb-3" action="{{ $action }}" method="POST">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <div class="mb-3">
                  <label for="firstname" class="form-label">Họ </label>
                  <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Nhập họ" autofocus="" required>
                </div>
                <div class="mb-3">
                  <label for="middlename" class="form-label">Tên đệm</label>
                  <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Nhập tên đệm" autofocus="">
                </div>
                <div class="mb-3">
                  <label for="lastname" class="form-label">Tên</label>
                  <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Nhập tên" autofocus="" required>
                </div>
                <div class="mb-3">
                  <label for="username" class="form-label">Tài khoản</label>
                  <input type="text" class="form-control" id="username" name="username" placeholder="Nhập tài khoản" autofocus="" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="password" id="password" class="form-control" name="cfpassword" placeholder="············" aria-describedby="password" required>
                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                  </div>
                </div>
                ...
                <button type="submit" value="submit" form="formregistication" class="btn btn-primary d-grid w-100">Đăng ký</button>
              </form>

              <p class="text-center">
                <span>Bạn đã có tài khoản?</span>
                <a href="{{url('frontend/login')}}">
                  <span>Bấm để đăng nhập</span>
                </a>
              </p>
            </div>
          </div>
