				...
				<h1>Welcome, Adminstrator Admin!</h1>
					...
					<div class="container">
						...
						<div class="carousel-inner h-100">
								...
								<img class="d-block w-100  h-100" style="object-fit:contain" src="http://localhost/odfs/uploads/banner/1_wp2.jpg" alt="">
							</div>
										<div class="carousel-item h-100">
								<img class="d-block w-100  h-100" style="object-fit:contain" src="http://localhost/odfs/uploads/banner/wap1.png" alt="">
							</div>
									</div>
