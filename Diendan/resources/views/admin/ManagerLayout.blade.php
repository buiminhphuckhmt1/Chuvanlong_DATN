          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="index.php?controller=products" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table1"></i>
                <div data-i18n="Tables">List products</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="index.php?controller=orders" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table1"></i>
                <div data-i18n="Tables">List Orders</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ url('backend/categories') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table1"></i>
                <div data-i18n="Tables">Categories News</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ url('backend/news') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table1"></i>
                <div data-i18n="Tables">News</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="index.php?controller=contact" class="menu-link">
                <i class="menu-icon tf-icons bx bx-table1"></i>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('admin/assets/admin/layout2/assets/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
